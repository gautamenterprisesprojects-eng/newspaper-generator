...
export const WIZARD_FRONT_PAGE_DESIGNS: Array<{
  ...
  },
  {
    ...
    storyCount: 9,
    description:
      "बाईं लाल एडिटर रेल (फोटो, नाम व स्थान, पदनाम) ऊपर की दो पट्टियों पर, उसके साथ मुख्य खबर और एक संकरा साथी बॉक्स दाईं ओर, बीच में 3 │ 2 की पट्टी, और नीचे तीन बराबर हिस्से।",
  },
  {
    id: "CliffFrontSep15",
    name: "15 सितंबर 2026 फ्रंट पेज",
    storyCount: 10,
    description:
      "15 सितंबर 2026 के पृष्ठ 1 से: बाईं रेल दो सार-समाचार पट्टियों में बंटी है, तीन कॉलम की मुख्य खबर जिसके अंदर नेस्टेड लेख है, दायाँ पैकेज भी नेस्टेड बॉक्स के साथ, पूरी चौड़ाई की मध्य पट्टी जिसकी तस्वीर दूसरे कॉलम से शुरू होती है और ऊपर दाईं ओर संबंधित खबर का दो-कॉलम कट-इन बॉक्स है, और नीचे कार्टून रेल के साथ अर्थनीति पैकेज।",
  },
  {
    ...
    storyCount: 8,
    description:
      "ऊपर चार कॉलम की मुख्य खबर और दो कॉलम का दायाँ पैकेज, मुख्य खबर के भीतर एक कॉलम का कट-इन बॉक्स। बीच में पूरी चौड़ाई की पट्टी जिसमें दो कॉलम का कट-इन बॉक्स है, और नीचे तीन बराबर हिस्से।",
  },
  {
    ...
    storyCount: 8,
    description:
      "बाईं ओर दो कॉलम का खड़ा स्तंभ और उसके साथ चार कॉलम की मुख्य खबर जिसमें दो कॉलम का कट-इन बॉक्स है। नीचे 4 │ 2 की पट्टी जिसमें एक कॉलम का कट-इन है, और सबसे नीचे दो बराबर पैकेज।",
  },
  {
    ...
    storyCount: 8,
    description:
      "लगभग बराबर गहराई के तीन डेक, हर डेक में एक कट-इन बॉक्स — ऊपर पूरी चौड़ाई की मुख्य खबर में दो कॉलम का, बीच और नीचे की पट्टियों में एक-एक कॉलम का। फ़ीचर पेज जैसा संतुलित रूप।",
  },
  {
    ...
    storyCount: 9,
    description:
      "ऊपर तीन बराबर खबरें, बीच में पाँच कॉलम की मुख्य खबर जिसके भीतर दो कट-इन बॉक्स हैं — एक दो कॉलम का ऊपर और एक कॉलम का नीचे, जिनके बीच से खबर का टेक्स्ट बहता है। नीचे दो बराबर पैकेज।",
  },
  {
