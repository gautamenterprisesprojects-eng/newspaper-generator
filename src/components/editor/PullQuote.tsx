...
import type { ArticleLayoutTextBlock, PullQuoteLayout } from "@/types/editor";
  ...
  return (
    <Group>
      ...
      <Rect
        ...
        cornerRadius={displayBlock.containerStyle.mode === "pill" ? frameBounds.height / 2 : displayBlock.containerStyle.containerBorderRadius}
        listening={false}
      />
    ) : null}
...
export function PullQuote({ layout }: PullQuoteProps) {
  return (
    <Group>
      <Rect
        x={layout.x}
       ...
       listening={false} perfectDrawEnabled={false} />
      {renderTextBlock(layout.textBlock)}
    </Group>
  );
}
